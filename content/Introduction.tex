...
Several Command line tools display information on loaded entities, e.g. \texti{rosnode} shows information about active nodes such as its publications and subscriptions, supports pinging them, manually killing nodes etc. 
